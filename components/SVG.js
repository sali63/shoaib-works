...
export const Github = ({ fill = '#33323D' }) => {
  return (
...
export const Twitter = ({ fill = '#33323D' }) => {
  return (
...
export const LinkedIn = ({ fill = '#33323D' }) => {
  return (
...
export const ArrowLeft = ({ stroke = '#33323D' }) => {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' width='10' height='16'>
      <path fill='none' stroke={stroke} d='M9 0L1 8l8 8' />
    </svg>
  );
};

export const ArrowRight = ({ stroke = '#33323D' }) => {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' width='10' height='16'>
...
export const Hamburger = ({ fill = '#33323D' }) => {
  return (
...
export const Close = ({ fill = '#33323D' }) => {
  return (
